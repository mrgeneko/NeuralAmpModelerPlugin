...
The macOS installer package identifiers default to `com.GeneKo.*`. Set `INSTALLER_PKG_ID_PREFIX` to use your own reverse-DNS prefix, for example `com.example.myproduct`.
